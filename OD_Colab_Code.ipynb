...
#To check for any corrupted images
TRAIN_IMAGE_FILE = '/Custom_OD/Workspace/images/Train'
TEST_IMAGE_FILE = '/Custom_OD/Workspace/images/Train'
import glob
from skimage import io
import cv2
files=[]
files=glob.glob(TRAIN_IMAGE_FILE+ '\*.jpg')
//files=glob.glob(TEST_IMAGE_FILE+ '\*.jpg')
...
LABEL_MAP_FILE=r'Custom_OD/Workspace/Annotations/label_map.pbtxt'
TRAIN_XML_FILE='/Custom_OD/Workspace/images/Train'
TRAIN_TF_RECORD_DIR='Custom_OD/Workspace/Annotations/train.record'
TEST_XML_FILE='/Custom_OD/Workspace/images/Test'
TEST_TF_RECORD_DIR='Custom_OD/Workspace/Annotations/test.record'
...
examples = xml_to_df(TRAIN_XML_FILE)
grouped_train = split(examples, 'filename')
...
examples = xml_to_df(TEST_XML_FILE)
grouped_test = split(examples, 'filename')
